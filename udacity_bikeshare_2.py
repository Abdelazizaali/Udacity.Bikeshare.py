...
def user_stats(df):
    ...
    if 'Birth Year' in df.columns:
        print(f'Earliest birth year is: {df["Birth Year"].min():.0f}')
        print(f'most recent is: {df["Birth Year"].max()}')
        print(f'and most common birth year is:'f'{df["Birth Year"].mode()[0]:.0f}')
